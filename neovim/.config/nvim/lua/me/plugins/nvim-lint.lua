...
local function config()
  ...
  local linters = {lua = {"luacheck", "codespell"}, clojure = {"clj-kondo"}, sh = {"shellcheck"}, java = {"codespell"}, javascript = {"eslint"}, typescript = {"eslint"}, vue = {"eslint"}, go = {"golangcilint"}, python = {"ruff"}, yaml = {"yamllint"}, gitcommit = {"codespell"}, php = {"phpcs"}, ruby = {"rubocop"}, fennel = {"fennel"}}
  setup_phpcs()
